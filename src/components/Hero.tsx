...
const Hero = () => {
  return (
    <div className="relative min-h-[70vh] flex items-center bg-[#FDE1D3]">
      <div className="container mx-auto px-4 z-10">
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="max-w-xl mb-8 md:mb-0">
            <h1 className="font-serif text-4xl md:text-5xl text-slate-800 mb-6 animate-fade-in">Belleza y Bienestar de Lujo!</h1>
