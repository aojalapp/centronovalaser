...
const Hero = () => {
  return <div className="relative min-h-screen flex items-center bg-[url('/lovable-uploads/588e9c3b-0fbb-49c8-8b79-f4dee8a55ada.png')] bg-cover bg-center">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-3xl">
          ...
          <button className="btn-primary flex items-center space-x-2 animate-fade-in" style={{
          animationDelay: "0.4s"
        }}>
